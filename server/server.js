...
app.use(
  cors({
    origin: "http://192.168.0.140:1342",
    credentials: true,
...
app.use((req, res, next) => {
  res.header("Access-Control-Allow-Origin", "http://192.168.0.140:1342");
...
function authMiddleware(req, res, next) {
  ...
  if (clientIP !== "http://192.168.0.140:1342") {
    return res.redirect("http://192.168.0.140:1342/*");
  }
